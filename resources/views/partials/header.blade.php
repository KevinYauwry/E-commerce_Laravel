<section id="header">
            ...
            <div>
                <ul id="navbar">
                    ...
                    <li><a class="{{ in_array(Route::currentRouteName(), ['shop', 'product']) ? 'active' : '' }}" href="{{ route('shop') }}">Shop</a></li>                    <li><a class="{{ Route::currentRouteName() == 'blog' ? 'active' : '' }}" href="{{ route('blog') }}">Blog</a></li>
